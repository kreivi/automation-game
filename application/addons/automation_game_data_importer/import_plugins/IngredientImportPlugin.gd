...
func _get_importer_name() -> String:
	return "automationgame.data.importer.ingredients"


func _get_visible_name() -> String:
	return "Automation Game - Ingredients"
			...
			return [
				{
					...
					"hint_string": "The directory where the imported ingredients will be saved.",
				},
				{
					"name": "FullImport",
					"default_value": true,
					"hint_string": "When enabled all existing ingredients and directory will be removed when importing.",
				}
			]
		_:
			return []
...
func _is_valid_data(data: Dictionary) -> bool:
	return not \
		...
		data.has("type") and data.get("type") is float # TODO: Cast to integer
